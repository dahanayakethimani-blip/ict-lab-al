...
import { LayoutDashboard, Binary, Cpu, Bot, BookOpen, Workflow, FileText, Database, CircuitBoard, Network, Code, ShoppingCart, Table, Globe, Zap, Server, BrainCircuit, ClipboardList, Menu, X, Flame, Trophy, Calendar, TrendingUp } from 'lucide-react';
